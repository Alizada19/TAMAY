...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  ...
  <a href="<?=base_url().'cdbtorsList'?>" target="_blank" class="w3-bar-item w3-button">List Records</a>
...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">	
	<div style="margin:5px 5px 5px 5px;">
		...
		<div style="display:inline-block; text-align:center;font-weight:bold;font-size:20px;">
			<h4>Tamay</h4>
			<h4>View Invoice Payment Form</h4>
	...
	<div style="width:100%" style="margin-right:1%;">
		<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
		  ...
		  <tr>
			  ...
			  <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;">RM <?=$query->camount?></td> 
		  </tr>
		  <tr>
		...
		<table style="width:100%;font-size:20px;float:left;margin-top:0px;margin-bottom:10px;border:none !important; background-color:yellow;">
			<tr>
				<td style="font-weight:bold;">Step 1/2 Now Please Make sure to do the related paid (If cheque do cheque payment/if O/C do O/C paid)</td>
			<tr>
		</table>
	<!--<div class="row" style="margin:5px 5px 5px 0px;width:100%; ;">
	   <input type="submit" name="btn_result"   style="width:200px;" class="btn btn-primary line" value="Update Record" />
	</div>-->
</div>
<script>

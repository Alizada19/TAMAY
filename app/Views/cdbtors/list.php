...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  ...
  <a href="<?=base_url().'cdbtorsAdd'?>" target="_blank" class="w3-bar-item w3-button">Add Invoice</a>
  <a href="<?=base_url().'cdbtorsAddPay'?>" target="_blank" class="w3-bar-item w3-button">Payment Invoice</a>
</div>
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  <button class="w3-bar-item w3-button w3-large" onclick="w3_close()">Close &times;</button>
		...
		<div id="tblCon">
			...
			?>
				...
				<td style="width:7%;padding-left:5px;">
					<a style="test-decoration: none;" title="Edit Record" href="<?=base_url()?><?=$vaddorpay?>/<?=$row->Id?>/2" target="_blank">View</a>
					<a style="test-decoration: none;" title="Edit Record" href="<?=base_url()?><?=$addorpay?>/<?=$row->Id?>" target="_blank">Edit</a>
				</td>
				</tr>
			...
			<div class="row" style="margin:5px 5px 5px 0px;width:100%; ;">	
			   <a style="" title="Export PDF" href="<?=base_url('printpdfcdbc/')?><?=$dbc?>" target="_blank"><input type="button"  name="btn_result" style="width:200px;" class="btn btn-primary line" value="Export PDF" /></a>
			</div>
			<div class="row" style="margin:5px 5px 5px 0px;width:100%;">
			<?//=displayPagination()?>	
			</div>

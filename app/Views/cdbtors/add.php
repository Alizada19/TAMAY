...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
	<form id="form1" method="post" action="<?=base_url()?>cdbtorsSave">
	...
	<div style="width:100%" style="margin-right:1%;">
		<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
		  <tr>
			  ...
			  <td colspan="3" style="width:30%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="dinvNo" id="dinvNo"  type="text" placeholder="No" onblur="" /></td> 
		  </tr>	
		  <tr>
			 <td style="width:10%;background-color:#b3d7ff87;padding-left:5px;">Invoice Date:</td>
		     <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="ddate" id="ddate" type="date" placeholder="dd/mm/YY" onblur="" required /></td>
		  </tr>
		  <tr>
			 <td style="width:10%;background-color:#b3d7ff87;padding-left:5px;">Due Date:</td>
		     <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="duedate" id="duedate" type="date" placeholder="dd/mm/YY" onblur="" /></td>
		  </tr>
		  <tr>
			  <td style="width:10%;background-color:#b3d7ff87;padding-left:5px;">Reference:</td>
			  <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="ddescrip" id="ddescrip" type="text" placeholder="Text" onblur="" required /></td>
		  </tr>
		  <tr>
			  <td style="width:12%;background-color:#b3d7ff87;padding-left:5px;">Amount:</td>
			  <td colspan="3" style="width:30%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="damount" id="damount"  type="text" placeholder="RM 0" onblur="" required /></td> 
		  </tr>
		  <tr>
			    <tr>

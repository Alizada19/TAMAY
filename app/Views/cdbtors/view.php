	...
	<div style="width:100%" style="margin-right:1%;">
		...
		<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
		 <tr>
			  ...
			  <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=$query->dinvNo?></td>
		  </tr>	
		 <tr>
			 <td style="width:10%;background-color:#b3d7ff87;padding-left:5px;">Invoice Date:</td>
		     <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=date_format(date_create($query->ddate), 'd/m/Y')?></td>
		  </tr>
		  <tr>
			 <td style="width:10%;background-color:#b3d7ff87;padding-left:5px;">Due Date:</td>
		     <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?php 
			 if($query->duedate!='0000-00-00' AND !is_null($query->duedate))
			 {	 
				echo date_format(date_create($query->duedate), 'd/m/Y');
			 }
			 ?></td>
		  </tr>
		  <tr>
			  <td style="width:10%;background-color:#b3d7ff87;padding-left:5px;">Description:</td>
			  <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=$query->ddescrip?></td>
		  </tr>
		  <tr>
			  <td style="width:12%;background-color:#b3d7ff87;padding-left:5px;">Debit Amount:</td>
			  <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;">RM <?=$query->damount?></td> 
		  </tr>
		  <tr>
			  <td style="width:12%;background-color:#b3d7ff87;padding-left:5px;">Debitor Name:</td>
			  <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=getdbc($query->dbc)?></td> 
		  </tr>
		</table>	
		<table style="width:100%;font-size:20px;float:left;margin-top:0px;margin-bottom:10px;border:none !important; background-color:yellow;">
			<tr>
				<td style="font-weight:bold;">Step 1/2 Now Please Make sure to do the related amount entry in cheque/On Account</td>
			<tr>
		</table>
	<div class="row" style="margin:5px 5px 5px 0px;width:100%; ;">
	   <a title="Update Current Record" href="<?=base_url('cdbtorsEdit/')?><?=$query->Id?>"><input type="button" name="btn_result" style="width:200px;" class="btn btn-primary line" value="Update Record" /></a>
	</div>
</div>
<script>

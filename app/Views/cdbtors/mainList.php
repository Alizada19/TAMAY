...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
	...
	<!-- Filter Search-->
	<div>
		<form id="form1" method="post" action="<?=base_url('dbcsearch')?>">
	...
	<div style="margin:5px 5px 5px 5px;">
		...
		<div id="tblCon">
			...
			?>
				<tr class="phover" style=" cursor: pointer;" title='Click To See Details' onclick="window.open('<?=base_url('cdbtorsList/')?><?=$row->dbc?>', '_blank');">
			...
			<div class="row" style="margin:5px 5px 5px 0px;width:100%; ;">	
			   <a style="" title="Export PDF" href="<?=base_url('printpdfbal')?>" target="_blank"><input type="button"  name="btn_result" style="width:200px;" class="btn btn-primary line" value="Export PDF" /></a>
			</div>
			<div class="row" style="margin:5px 5px 5px 0px;width:100%;">
			<?//=displayPagination()?>	
			</div>

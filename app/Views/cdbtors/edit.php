	...
	<div style="width:100%" style="margin-right:1%;">
		<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
		  ...
		  <tr>
		     ...
		     <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="duedate" id="duedate" type="date" placeholder="" value="<?=$query->duedate?>" onblur="" /></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			  ...
			  <td colspan="3" style="width:30%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="damount" id="damount"  type="text" placeholder="RM 0" onblur="" value="<?=$query->damount?>" required /></td> 
		  </tr>
		  <tr>
			    <tr>

...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
	...
	<div class="row" style="margin:5px 5px 5px 0px;width:100%; ;">
	   <a title="Update Current Record" href="<?=base_url('dailyformUpdate/')?><?=$query->Id?>"><input type="button" name="btn_result" style="width:200px;" class="btn btn-primary line" value="Update Record" /></a>
	   <a style="margin-left:20px;" title="Update Current Record" href="<?=base_url('printpdf/')?><?=$query->Id?>" target="_blank"><input type="button"  name="btn_result" style="width:200px;" class="btn btn-primary line" value="Export PDF" /></a>
	</div>
</div>
<script>

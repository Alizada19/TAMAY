...
<table cellpadding="5px" style="width:100%;font-size:15px;float:left;margin-top:10px;margin-bottom:10px;">
	<tr>
		<td colspan="9" align="center" style="width:100%;background-color:#4caf50;font-weight:bold;">Cash Deposit List</td>
	</tr>
	<tr>
		...
		<td style="width:10%;background-color:#b3d7ff87;padding-left:5px;font-weight:bold;">Deduction</td>
	...
	?>
	<tr>
		<td colspan="3" align="center" style="width:5%;background-color:#b3d7ff87;font-weight:bold;">Total Amount:</td>
		<td style="width:5%;background-color:#b3d7ff87;font-weight:bold;padding-left:5px;">RM <?=number_format($total->tamount,2)?></td>
		<td style="width:5%;background-color:#b3d7ff87;font-weight:bold;padding-left:5px;">RM <?=number_format($total->tdeduction,2)?></td>
		<td colspan="2" style="width:5%;background-color:#b3d7ff87;font-weight:bold;padding-left:5px;"></td>
	</tr>
</table>

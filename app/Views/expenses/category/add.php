		...
		<form id="form1" method="post" action="<?=base_url('expenses/categorySave')?>">
			<div style="width:100%" style="margin-right:1%;">
				<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
				  <tr>
					 ...
					 <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="cname" id="cname" type="text" placeholder="NAME" onblur="makeCapital(this.value,'cname')" required /></td>
				  </tr>

		...
		<form id="form1" method="post" action="<?=base_url('expenses/groupeEditSave/')?><?=$row->Id?>">
			<div style="width:100%" style="margin-right:1%;">
				<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
				  <tr>
					 ...
					 <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="gname" id="gname" type="text" placeholder="NAME" value="<?=$row->gname?>" onblur="makeCapital(this.value,'gname')" required /></td>
				  </tr>

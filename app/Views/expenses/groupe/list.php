...
<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
	<tr>
		<td colspan="5" align="center" style="width:100%;background-color:#4caf50;font-weight:bold;">Groupe List</td>
	</tr>
	<tr>
		<td align="center" style="width:5%;background-color:#b3d7ff87;font-weight:bold;">S.No</td>
		<td style="width:10%;background-color:#b3d7ff87;padding-left:5px;font-weight:bold;">Groupe Name</td>
	...
	?>
		<tr>
			...
			<td style="width:10%;background-color:#b3d7ff87;padding-left:5px;"><?=$row->gname?></td>
			...
			<td style="width:8%;padding-left:5px;background-color:#b3d7ff87;">
				<a style="test-decoration: none;" title="View Record" href="<?=base_url('expenses/groupeView/')?><?=$row->Id?>/2" target="_blank">View</a>
				<a style="test-decoration: none;" title="Edit Record" href="<?=base_url('expenses/groupeEditView/')?><?=$row->Id?>" target="_blank">Edit</a>
			</td>
		</tr>

			...
			<div style="width:100%" style="margin-right:1%;">
				<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
				  ...
				  <tr>
					 ...
					 <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="pname" id="pname" type="text" value="<?=$row->name?>" required /></td>
				  </tr>
				  <tr>
				  ...
				  <tr>
					 ...
					 <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="remark" id="remark"  placeholder="Remark" value="<?=$row->remark?>" type="text" /></td>
				  </tr>
				  <tr>

  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content shadow-lg rounded-4">
      <div class="modal-header bg-primary text-white rounded-top-4">
        <h5 class="modal-title">Add Cash Desposit Record</h5>
        <button type="button" class="btn-close btn-close-white" onclick="window.close()" aria-label="Close"></button>
      </div>
      <form enctype="multipart/form-data" action="<?=base_url('codeigniter/public/saveCash')?>" method="post">
        <div class="modal-body">
          ...
          <div class="mb-3">
            <label for="total_sales" class="form-label">Mention if any deduction</label>
            <input type="number" step="0.01" class="form-control" name="deduction" id="deduction" placeholder="0">
          </div>
		  <div class="mb-3">

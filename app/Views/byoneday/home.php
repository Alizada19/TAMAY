...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
		...
		<div id="tblCon">
			...
			<!--<div class="row" style="margin:5px 5px 5px 0px;width:100%; ;">	
			   <a style="" title="Export PDF" href="<?=base_url('printpdfDatebased/')?><?=$sdate?>" target="_blank"><input type="button"  name="btn_result" style="width:200px;" class="btn btn-primary line" value="Export PDF" /></a>
			</div>-->
		</div>

...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  ...
  {
   ?>
  <a href="<?=base_url().'pendingChequesCharts'?>" class="w3-bar-item w3-button">Pending Payments in 10 days.</a>
  <?php  } ?>
</div>
<div id="main">
...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
	...
	<div style="margin:5px 5px 5px 5px;">
		...
		<div class="row" style="margin:5px 5px 5px 0px;width:100%; ;">	
		   <a style="" title="Update Current Record" href="<?=base_url('printpdfNightReports/')?>" target="_blank"><input type="button"  name="btn_result" style="width:200px;" class="btn btn-primary line" value="Export PDF" /></a>
		</div>
	</div>
</div>
<script>

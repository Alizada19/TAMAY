...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
	...
	<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
		<tr>
		 <th colspan="2" style="width:100%;background-color:#b3d7ff87;text-align:center;">On Account</th>
		</tr>
		
		<tr> 
			 <td style="width:10%;background-color:#b3d7ff87;">Status:</td>
			 <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;">
			 <?php 
			 if($query->status == 1)
			 { 
				echo "Pending";
		...
		<tr>
			 ...
			 <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=$query->invDate?></td>
		</tr>
		<tr>
	...
	<div class="row" style="margin:5px 5px 5px 0px;width:100%; ;">
	   <a title="Update Current Record" href="<?=base_url('paymentupdateoc/')?><?=$query->Id?>"><input type="button" name="btn_result" style="width:200px;" class="btn btn-primary line" value="Update Record" /></a>
	</div>
</div>
<script>

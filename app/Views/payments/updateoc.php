...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
    ...
    <div id="payCon">
		<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
			<tr>
			 <th colspan="2" style="width:100%;background-color:#b3d7ff87;text-align:center;">On Account Form</th>
			</tr>
			...
			<tr>
			  ...
			  <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="invno" id="invno" type="text" placeholder="No" onblur="makeCapital(this.value,'invno')" value="<?=$query->invNo?>" required /></td>
			</tr>
			<tr>
			 <td style="width:10%;background-color:#b3d7ff87;">Invoice Date:</td>
			 <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="invDate" id="invDate" type="date" onblur="" value="<?=$query->invDate?>" /></td>
			</tr>
			<tr>
			 <td style="width:10%;background-color:#b3d7ff87;">Due Date:</td>
			 <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="ddate" id="ddate" type="date" onblur=""  value="<?=$query->ddate?>" /></td>
			</tr>
			<tr>

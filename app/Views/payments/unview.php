...
<head>
	<meta charset="utf-8">
	<title>TAMAY GROUP PAYMENT METHODS</title>
...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
	<div style="margin:5px 5px 5px 5px;">
		...
		<div style="display:inline-block;float:right;text-align:right; padding-top:30px;">
			...
			<?php 
				...
				{	
			?>
			<div style="background-color:#b3d7ff87; max-width: 100%;" class="alert  alert-dismissible d-flex align-items-center fade show ">
	...
	<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
		...
		<tr> 
			 <td style="width:10%;background-color:#b3d7ff87;">Status:</td>
			 <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;color: o;">
				<?php
					if($query->status==1)
					{
						echo "Pending";
		...
		<tr>
			 ...
			 <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=$query->invNo?></td>
		</tr>
		<tr>
			 <td style="width:10%;background-color:#b3d7ff87;">Cheque No:</td>
			 <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=$query->cno?></td>
		</tr>
		<tr>
			 <td style="width:10%;background-color:#b3d7ff87;">Bank Name:</td>
			 <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=bankname($query->bname)?></td>
		</tr>
		<tr>
			 <td style="width:10%;background-color:#b3d7ff87;">Due Date:</td>
			 <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=$query->ddate?></td>
		</tr>
		</tr>
		<tr>
			 <td style="width:10%;background-color:#b3d7ff87;">Amount:</td>
			 <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=$query->amount?></td>
		</tr>
		<tr>
			 <td style="width:10%;background-color:#b3d7ff87;">Pay to:</td>
			 <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=getdbc($query->pto)?></td>
		</tr>
		<tr>
			 <td style="width:10%;background-color:#b3d7ff87;">Remark:</td>
			 <td colspan="3" style="width:26%;font-weight:bold;font-size:30px;padding-left:10px;background-color:#b3d7ff87;"><?=$query->remark?></td>
		</tr>
	</table>
	</div>
	
	<div class="row" style="margin:5px 5px 5px 0px;width:100%; ;">
	   <a title="Update Current Record" href="<?=base_url('paymentschedupv/')?><?=$query->Id?>"><input type="button" name="btn_result" style="width:200px;" class="btn btn-primary line" value="Update Record" /></a>
	</div>
</div>
<script>

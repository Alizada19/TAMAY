...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
	...
	<div class="row" style="margin:5px 5px 5px 0px;width:100%; ;">
	   <a title="Update Current Record" href="<?=base_url('paymentupdatec/')?><?=$query->Id?>"><input type="button" name="btn_result" style="width:200px;" class="btn btn-primary line" value="Update Record" /></a>
	</div>
</div>
<script>

...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
		  ...
		  <tr style="display:none;">
			<td colspan="4" style="width:100%;background-color:#b3d7ff87;">
				<select  style="background-color:#b3d7ff87;width:100%;font-size:20px;"  id="ptype" name="ptype"  tabindex="1005" onchange="bringPayf(this.value)" required>
				    ...
				    <option value="4" selected>Unscheduled</option>
				</select>
			</td>
		  </tr>
		</table>
    ...
    <div id="payCon">
		<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
			...
			<tr>
				<td colspan="4" style="width:100%;background-color:#b3d7ff87;">
					<select  style="background-color:#b3d7ff87;width:100%;font-size:20px;"  id="pstatus" name="pstatus"  tabindex="1005" >
						<?=$pstr?>															
					</select>
				</td>
			</tr>
			<tr>
			  ...
			  <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="invno" id="invno" type="text" placeholder="No" onblur="makeCapital(this.value,'invno')" value="<?=$query->invNo?>" /></td>
			</tr>
			<tr>
			<td colspan="4" style="width:100%;background-color:#b3d7ff87;">
			...
			<tr>
			  ...
			  <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="cno" id="cno" type="text" placeholder="No" onblur="makeCapital(this.value,'cno')" value="<?=$query->cno?>"  /></td>
			</tr>
			<tr>
			 <td style="width:10%;background-color:#b3d7ff87;">Due Date:</td>
			 <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="ddate" id="ddate" type="date" onblur="makeCapital(this.value,'ddate')"  value="<?=$query->ddate?>" /></td>
			</tr>
			</tr>
			<tr>
			  <td style="width:10%;background-color:#b3d7ff87;">Amount:</td>
			  <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="amount" id="amount" type="text" placeholder="RM 0" onblur="makeCapital(this.value,'amount')" value="<?=$query->amount?>"  /></td>
			</tr>
			<tr>
				<td colspan="4" style="width:100%;background-color:#b3d7ff87;">
			...
			<tr>
			  ...
			  <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="remark" id="remark" type="textarea" placeholder="RM 0" onblur="makeCapital(this.value,'remark')" value="<?=$query->remark?>" /></td>
			</tr>
		</table>
	</div>

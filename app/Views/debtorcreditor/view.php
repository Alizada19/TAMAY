...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
	...
	<div style="width:100%" style="margin-right:1%;">
		<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
			<tr>
			  <td style="width:10%;background-color:#b3d7ff87;padding-left:5px;font-size:25px;">D/C Name:</td>
			  <td colspan="3" style="width:26%;font-size:25px;padding-left:10px;background-color:#b3d7ff87;"><?=$result->dcnames?></td>
			</tr>
			<tr>
			<td style="width:10%;background-color:#b3d7ff87;padding-left:5px;font-size:25px;">Type:</td>
				  <td colspan="3" style="width:26%;font-size:25px;padding-left:10px;background-color:#b3d7ff87;"><?=dbcType($result->type)?></td>
			</tr>
			<td style="width:10%;background-color:#b3d7ff87;padding-left:5px;font-size:25px;">Address:</td>
				  <td colspan="3" style="width:26%;font-size:25px;padding-left:10px;background-color:#b3d7ff87;"><?=$result->addr?></td>
			</tr>
			<td style="width:10%;background-color:#b3d7ff87;padding-left:5px;font-size:25px;">Phone:</td>
				  <td colspan="3" style="width:26%;font-size:25px;padding-left:10px;background-color:#b3d7ff87;"><?=$result->phone?></td>
			</tr>
			<td style="width:10%;background-color:#b3d7ff87;padding-left:5px;font-size:25px;">Incharge Name:</td>
				  <td colspan="3" style="width:26%;font-size:25px;padding-left:10px;background-color:#b3d7ff87;"><?=$result->pname?></td>
			</tr>
		</table>
	</div>	
    <div id="payCon">
	...
	<div class="row" style="margin:5px 5px 5px 0px;width:100%; ;">
	   <a title="Update Current Record" href="<?=base_url('debtorcreditoredit/')?><?=$result->Id?>"><input type="button" name="btn_result" style="width:200px;" class="btn btn-primary line" value="Update Record" /></a>
	</div>
</div>
<script>

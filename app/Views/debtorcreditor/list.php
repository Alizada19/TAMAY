			...
			?>
				<tr>
					...
					<td style="width:10%;padding-left:5px;">
						<a style="test-decoration: none;" title="View Record" href="<?=base_url('debtorcreditorView/')?><?=$row->Id?>" target="_blank">View</a>
						<a style="test-decoration: none;" title="Edit Record" href="<?=base_url('debtorcreditoredit/')?><?=$row->Id?>" target="_blank">Edit</a>
					</td>
				</tr>

...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  ...
  {
   ?>
  <a href="<?=base_url('debtorcreditorlist')?>" target="_blank" class="w3-bar-item w3-button">Debtor/Creditor List</a>
  <?php  } ?>
  <?php 
  if($this->session->get('myRole') == 1)
  {
...
<div id="container" style="padding:5px 5px 5px 5px;width:100%;">
	<form id="form1" method="post" action="<?=base_url()?>savedebtorcreditor">
	...
	<div style="width:100%" style="margin-right:1%;">
		<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
			<tr>
			  <td style="width:10%;background-color:#b3d7ff87;padding-left:5px;">Debtor/Creditor:</td>
			  <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="dcname" id="dcname" type="text" placeholder="Please Write in Capital Letters" onblur="makeCapital(this.value,'dcname')" required /></td>
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="addr" id="addr" type="text" placeholder="Address" /></td>
			</tr>
			<tr>
			  <td style="width:10%;background-color:#b3d7ff87;padding-left:5px;">Phone No:</td>
			  <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="phone" id="phone" type="text" placeholder="Phone No" /></td>
			</tr>
			<tr>
			  <td style="width:10%;background-color:#b3d7ff87;padding-left:5px;">PIC:</td>
			  <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="pname" id="pname" type="text" placeholder="PIC" /></td>
			</tr>
		</table>
	</div>	
    <div id="payCon">
	...
	<div class="row" style="margin:5px 5px 5px 0px;width:100%;" id="sbutton">
	   <input type="submit" name="btn_result"   style="width:200px;" class="btn btn-primary line" value="Save" onclick="makeCapital3('dcname')"/>
	</div>
	</form>
</div>
<script>
...
function makeCapital3(id)
{
	var v = document.getElementById(id).value = myString; 
	myString = v.toUpperCase();
	document.getElementById(id).value = myString;
	document.getElementById(id).style="background-color:#b3d7ff87;font-size:30px;font-weight:bold";
}

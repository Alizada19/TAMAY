<div style="margin-top: 10%;">
	...
	<div style="width:98%; margin-right:1%; margin-left:1%;">	
		<div style="text-align:center; font-weight:bold;font-size: 18px;">
			List of transfered stocks grouped by category
		</div>
		...
		<div>
			<input type="submit" value="Export PDF" name="btn_result" onclick="submitForm('<?=base_url('printCategory')?>')" style="width:100px;" class="btn btn-primary line"></button>
		</div>
	</div>
	</div>
</div>

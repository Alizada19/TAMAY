<table cellpadding="5px" style="width:100%;font-size:15px;float:left;margin-top:10px;margin-bottom:10px;">
	<tr>
		<td colspan="9" align="center" style="width:100%;background-color:#4caf50;font-weight:bold;">Leave List</td>
	</tr>
	<tr>
	...
	?>
		<tr>
			<td align="center" style="width:5%;background-color:#b3d7ff87;">dfa</td>
	...
	<tr>
		...
		<td style="width:5%;background-color:#b3d7ff87;font-weight:bold;padding-left:5px;">RM <dfa</td>
	</tr>
</table>